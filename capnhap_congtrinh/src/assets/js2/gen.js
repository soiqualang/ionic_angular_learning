function showselectbox(divid,id){
	if(divid=='iddistricts'){
		selectbox_v2('div_idwards_congtrinh','idwards','Xã','wards','iddistricts='+id,'idwards','tenwards');
		selectbox_v2('div_idwards_thuyvan','idwards','Xã','wards','iddistricts='+id,'idwards','tenwards');
	}
	if(divid=='idlinhvuc'){
...
function selectbox_v2(divname,name,label,tbl,dk,id,ten){
	var str='';
	var opt='';
