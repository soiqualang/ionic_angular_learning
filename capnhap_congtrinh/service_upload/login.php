...
require('function.php');
  ...
  // Phần xử lý của các bạn..
    ...
    {    
		...
		$_SESSION['idphongban'] = getElement('users','idphongban','email',$email);
		$_SESSION['tenphongban'] = getElement('phongban','tenphongban','id',$_SESSION['idphongban']);
		$_SESSION['login'] = true;
		
		@$user_info->email=$_SESSION['email'];
		@$user_info->fullname=$_SESSION['fullname'];
		@$user_info->tenphongban=$_SESSION['tenphongban'];
